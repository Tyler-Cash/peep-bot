    ...
    return (
        <div className="login-page">
            <div className="login-card">
                ...
                <p className="login-description">Sign in with Discord to view and manage events for your server.</p>
                <a
                ...
                <p className="login-privacy">I only store your account ID and username.</p>
            </div>
        </div>
    );
}
