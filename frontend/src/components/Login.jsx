    ...
    return (
        <div className="login-page">
            <div className="login-card">
                ...
                <h1 className="login-title"><span className="brand-peep">Peep</span> <span className="brand-bot">Bot</span></h1>
                <p className="login-subtitle">Discord event management</p>
                ...
                <p className="login-privacy">We only store your account ID and username.</p>
            </div>
        </div>
    );
}
