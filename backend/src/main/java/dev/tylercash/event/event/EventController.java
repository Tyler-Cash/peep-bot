...
public class EventController {
    ...
    public Map<String, String> updateEvent(
        ...
        if (!isAdmin && !isCreator) {
            log.warn("User {} attempted to update event {} without permission", discordId, event.getId());
            throw new ResponseStatusException(
                    HttpStatus.FORBIDDEN, "Only the creator or an admin can update the event");
        }
