...
class ResponseSerializationTest {
    ...
    static List<Object> populatedControllerDtos() {
        ...
        out.add(new GuildDto("123", "Guild", "G", "icon", "#fff", 5, 1.0, 2.0));
        out.add(new GuildSettingsDto(
                "place-id", "place-name", 1.0, 2.0, null, null, null, null, null, null, null, null, null, 90, true, 5));
